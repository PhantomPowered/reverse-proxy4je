 ...
 * be {@link de.derrop.minecraft.proxy.api.util.ChatColor#RED} and "World" would be
 * {@link de.derrop.minecraft.proxy.api.util.ChatColor#BLUE} but "!" would be bold and
 * {@link de.derrop.minecraft.proxy.api.util.ChatColor#BLUE} because append copies the previous
 * part's formatting
 * </p>
 */
@NoArgsConstructor
