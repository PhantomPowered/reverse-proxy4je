package de.derrop.minecraft.proxy.api.chat.component;

import de.derrop.minecraft.proxy.api.chat.ClickEvent;
import de.derrop.minecraft.proxy.api.chat.ComponentBuilder;
...
public abstract class BaseComponent {
     ...
     * ({@link de.derrop.minecraft.proxy.api.util.ChatColor#COLOR_CHAR}
     *
     ...
     * component doesn't have one. {@link de.derrop.minecraft.proxy.api.util.ChatColor#WHITE}
