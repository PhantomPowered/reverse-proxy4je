...
import com.github.derrop.proxy.api.chat.ComponentBuilder;
...
public abstract class BaseComponent {
    ...
    public boolean equals(final Object o) {
        ...
        if (this$hoverEvent == null ? other$hoverEvent != null : !this$hoverEvent.equals(other$hoverEvent))
            return false;
        return true;
    }
    ...
    public String toString() {
        return "BaseComponent(color=" + this.getColor() + ", bold=" + this.bold + ", italic=" + this.italic + ", underlined=" + this.underlined + ", strikethrough=" + this.strikethrough + ", obfuscated=" + this.obfuscated + ", insertion=" + this.insertion + ", extra=" + this.extra + ", clickEvent=" + this.clickEvent + ", hoverEvent=" + this.hoverEvent + ")";
    }
