package com.github.derrop.proxy.plugins.gomme.messages.defaults;
...
public class ClanMessageRegistry extends MessageRegistry {
    ...
    public ClanMessageRegistry() {
        ...
        super.registerMessage(Language.GERMANY, MessageType.CLAN_INFO_BEGIN, "[Clans]  Clan-Informationen", () -> null);
        ...
        super.registerMessage(Language.GERMANY, MessageType.CLAN_INFO_CLAN_PAGE, " Clanpage: Klick", () -> null);
        ...
        super.registerRegExMessage(Language.GERMANY, MessageType.CLAN_INFO_USER, // TODO stripColor has to be disabled for this to work
