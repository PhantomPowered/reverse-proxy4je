...
public class PacketPlayPluginMessage extends DefinedPacket {
    ...
    public static final Predicate<PacketPlayPluginMessage> SHOULD_RELAY = input -> (
            input.getTag().equals("REGISTER") ||
                    input.getTag().equals("minecraft:register") ||
                    input.getTag().equals("MC|Brand") ||
                    input.getTag().equals("minecraft:brand")
