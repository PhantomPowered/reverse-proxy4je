...
@ToString
public class PacketPlayServerMultiBlockUpdate extends DefinedPacket {
    ...
    public class BlockUpdateData {
        ...
        public BlockPos getPos() {
            int chunkX = PacketPlayServerMultiBlockUpdate.this.chunkX;
            int chunkZ = PacketPlayServerMultiBlockUpdate.this.chunkZ;
