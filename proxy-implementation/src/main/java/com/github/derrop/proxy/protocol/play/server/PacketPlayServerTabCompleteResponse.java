...
public class PacketPlayServerTabCompleteResponse extends DefinedPacket {
    ...
    public PacketPlayServerTabCompleteResponse(int transactionId, Suggestions suggestions) {
